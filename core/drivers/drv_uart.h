...
/* UART registers */
#define UART_DAT(base)		REG8(base + 0x00)
#define UART_IER(base)		REG8(base + 0x01)
#define UART_IIR(base)		REG8(base + 0x02)
#define UART_FCR(base)		REG8(base + 0x02)
#define UART_LCR(base)		REG8(base + 0x03)
#define UART_MCR(base)		REG8(base + 0x04)
#define UART_LSR(base)		REG8(base + 0x05)
#define UART_MSR(base)		REG8(base + 0x06)

#define UART_LSB(base)		REG8(base + 0x00)
#define UART_MSB(base)		REG8(base + 0x01)
